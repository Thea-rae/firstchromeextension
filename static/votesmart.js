(function () {
  ...
  VoteSmart.prototype.init = function (apiKey, baseUrl, output) {
    this.apiKey = '944fcca757b2fa9f737c1e6cea57311b';
  ...
  VoteSmart.prototype._querystring = function (q, apiKey) {
    var string, query, k;
    string = [];
    for (k in q) {
    ...
    query = string.join('&')
    return '?key=' + this.apiKey + '&o=' + this.output + '&' + query;
  }
  ...
  if (typeof module !== 'undefined' && module.exports) {
    ...
    VoteSmart.prototype._urlConstructor = function (constructor) {
      ...
      return this.baseUrl + resource +
        this._querystring(constructor, this.apiKey);
    }
